...
CREATE TABLE `posts` (
  ...
  `poster` varchar(45) COLLATE utf8_swedish_ci NOT NULL,
  `date_posted` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`PID`),
  UNIQUE KEY `PID_UNIQUE` (`PID`),
  KEY `Users_post_idx` (`USID`),
  CONSTRAINT `Users_posts` FOREIGN KEY (`USID`) REFERENCES `users` (`USID`)
...
-- Dump completed on 2022-05-12  3:28:48
